...
public interface AnalysticService {
    ...
    List<AnalysticResponseDto> getAllAnalysticsData();
    ...
    List<AnalysticResponseDto> getAnalysticsDataByDateRange(LocalDate startDate, LocalDate endDate);
    ...
    AnalysticStatDto getAnalysticStatDataByDateRange(LocalDate startDate, LocalDate endDate);

    /**
     * Thống kê số lượng prediction (chấp nhận / từ chối) cho từng employee.
     */
